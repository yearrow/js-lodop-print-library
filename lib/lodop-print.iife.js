var lodopPrint = (function (exports) {
  ...
  class DrawComponent {
    ...
    drawBarcode(option) {
      LODOP.ADD_PRINT_BARCODE(option.params.Top, option.params.Left, option.params.Width, option.params.Height, option.params.CodeType || '128A', option.params.CodeValue);
